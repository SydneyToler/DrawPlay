...
public class Cat {
	...
	private static final int EYE_SEPARATION = HEAD_DIMENSION/8; //make eyes close together
	// pick eye dimensions
	...
	public void draw(Graphics g, int catX, int catY)
	{
		...
		g2.fillOval(x, y, EYE_WIDTH, EYE_HEIGHT);
		// Draw the mouth
		g2.setColor(Color.red); //changed mouth color to red
		x = catX + MOUTH_X;
		y = catY + MOUTH_Y;
		...
		g2.drawString("HISS", catX, catY+HEAD_DIMENSION+10);	//cat hisses
	}
}
